...
<!--Container-->
<section class="row">
  <h3>Show User <button type="button" onclick="returnPage()" class="btn btn-success">
  ...
  <form id="modalForm" action="<?= APP_URL_PUBLIC ?>user/create" method="POST" onsubmit="return validateData()">
    ...
    <div class="form-floating mb-3">
      <input type="email" class="form-control form-control-sm" id="user_user" name="user_user"
        placeholder="name@example.com" value="<?= $user[0]['user_user'] ?>" disabled>
    ...
    <select class="form-select form-select-sm mb-3" id="user_status_id" name="user_status_id" aria-label="Small select example"
    disabled>
